<script>
    ...
    /**
     * @type {{ primary: { bg_img: { url: any; }; }; slice_type: any; variation: any; items: any; }}
     */
    export let slice;

    const bgImg = slice.primary?.bg_img?.url; // Optional chaining in case bg_img or url is not defined
